...
class MrshudsonSchedulerPgRepository(MrshudsonSchedulerRepository):
    ...
    async def introduce_myself(self, query: MrshudsonSchedulerQuery) -> MrshudsonSchedulerResponse:
        '''허드슨 부인의 자기소개'''
        logger.info(f"[MrshudsonSchedulerPgRepository] introduce_myself | id={query.id} name={query.name}")
