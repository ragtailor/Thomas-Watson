...
from sherlock_homes.adapter.outbound.repositories.police_mycroft_contact_Port import MycroftContactRepository
...
def get_mycroft_contact_use_case(
    ...
    repository: MycroftContactPort = MycroftContactRepository(session=db)
