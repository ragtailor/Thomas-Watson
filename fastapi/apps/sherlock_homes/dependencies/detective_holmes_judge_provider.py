...
from sherlock_homes.adapter.outbound.repositories.detective_holmes_judge_pg_repository import HolmesJudgePgRepository
...
def get_holmes_judge_use_case(
    ...
    repository: HolmesJudgeRepository = HolmesJudgePgRepository(session=db)
