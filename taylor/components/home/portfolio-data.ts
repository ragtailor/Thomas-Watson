...
export const portfolioCategoryLinks = [
  { label: "ALL", href: "/" },
  { label: "RAG SYSTEM", href: "/lesson/rag-system" },
  { label: "ARCHITECTURE", href: "/lesson/architecture" },
  { label: "AGENT", href: "/lesson/agent" },
  { label: "Tailor", href: "/lesson/tailor" },
  { label: "MOBILE", href: "/lesson/mobile" },
  { label: "DEVOPS", href: "/lesson/devops" },
  { label: "NLP", href: "/lesson/nlp" },
] as const;
...
export const portfolioItems: PortfolioItemData[] = [
  ...
  { id: "4", title: "FastAPI 기반 AI 서비스 엔진 구현", tag: "TAILOR" },
