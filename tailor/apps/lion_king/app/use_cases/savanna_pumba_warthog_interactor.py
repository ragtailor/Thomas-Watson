...
from tailor.apps.lion_king.adapter.inbound.api.schemas.savanna_pumba_warthog_schema import PumbaWarthogSchema
from tailor.apps.lion_king.app.dtos.savanna_pumba_warthog_dto import PumbaWarthogQuery, PumbaWarthogResponse
from tailor.apps.lion_king.app.ports.input.savanna_pumba_warthog_use_case import PumbaWarthogUseCase
